...
def minimax(grid, depth, maximizingPlayer, player_piece, opponent_piece):
    """Minimax algorithm with basic depth control and randomness among equally best options."""
    ...
    if maximizingPlayer:
        ...
        for col in valid_locations:
            ...
            _, score = minimax(temp_grid, depth - 1, False, player_piece, opponent_piece)
            if score > best_score:
                best_score = score
                best_cols = [col]
        ...
        for col in valid_locations:
            ...
            _, score = minimax(temp_grid, depth - 1, True, player_piece, opponent_piece)
            if score < best_score:
                best_score = score
                best_cols = [col]
            elif score == best_score:
